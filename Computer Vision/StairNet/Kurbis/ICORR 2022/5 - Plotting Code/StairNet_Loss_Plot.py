...
plt.ylabel('Loss', fontsize=16, fontfamily = "Arial")
...
plt.savefig("C:\\Users\\Garrett's Laptop\\Desktop\\ICORR_Plot_Revision\\Final Test Results\\StairNet\\StairNet_18_Loss_Plot_2.png", dpi=2000)
plt.show()